...
class _SuccessState extends State<Success> {
        ...
        children: [
          ...
          Scaffold(
            ...
            body: Column(
              ...
              children: [appbar(context, null, false), successColumn(context)],
            ),
          ),
        ],
      ),
  ...
  Column successColumn(BuildContext context) {
    return Column(
        ...
        Column(
          children: const [
            ...
            Text(
              ...
              style: TextStyle(fontSize: 22, fontFamily: 'Gilroy-Light'),
            ),
          ],
        ),
        Padding(
          ...
          child: SizedBox(
            ...
            child: CupertinoButton(
              ...
              child: const Text(
                'Ana Sayfaya Dön',
                style: TextStyle(fontFamily: 'Gilroy-ExtraBold', fontSize: 18),
              ),
              onPressed: () {
